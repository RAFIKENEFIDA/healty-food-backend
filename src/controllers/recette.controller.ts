...
const getManagerRecettes=  catchAsync(async (req: Request, res: Response) => {
    

   try{
   const Recettes = await Recette.find({managerId:req.params.id}).populate('categorieId',"nom").populate("ingredients.ingredient");
...
const getAllRecettes=  catchAsync(async (req: Request, res: Response) => {
    

   try{
   const Recettes = await Recette.find().populate('categorieId',"nom").populate("ingredients.ingredient");
...
export { createRecette, getManagerRecettes,getAllRecettes,updateRecette,deleteRecette,getOneRecette }
